...
public class salary {
	...
	public static void main(String[] args) {
		...
		System.out.println(" 1.PROGRAMMER \t 2.ASSISTANT PROFESSOR \t 3.ASSOCIATE \t 4.PROFESSOPR");
    ...
    output
    PAYROLL
 1.PROGRAMMER 	 2.ASSISTANT PROFESSOR 	 3.ASSOCIATE 	 4.PROFESSOPR
Enter Your Choice:1
